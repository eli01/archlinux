...
function getPopupWindowSpecs(params) {
	...
	if (Settings.read("setPositionAndSize") || params.testingOnly) {
		...
		specs += "left=" + (params.window.screen.availLeft+(params.window.screen.width/2)-(popupWidth/2)) + ",";
		specs += "top=" + (params.window.screen.availTop+(params.window.screen.height/2)-(popupHeight/2)) + ",";
